    ...
    <div >
      <div className={cx('header')} >
        <div className={cx('bodyheader')}>
          <Link href='/nemshop' > <img className={cx('img')} alt='img' src='https://theme.hstatic.net/200000182297/1000887316/14/logo.png?v=283' data-aos="fade-up" data-aos-easing="ease-in-out"
            data-aos-duration="1200" /></Link>
          <div className={cx('responsive')}>
            <Link href='/tatcasanpham' data-aos="fade-right"
              data-aos-easing="ease-in-out"
              data-aos-duration="1000" > SẢN PHẨM </Link>
          </div>
          <div className={cx('responsive')}>
            <Link href='/sanphammoi' data-aos="fade-right"
              data-aos-easing="ease-in-out"
              data-aos-duration="1200" > SẢN PHẨM MỚI </Link>
          </div >
          <div className={cx('responsive')}>
            <Link href='/bosuutap' data-aos="fade-right"
              data-aos-easing="ease-in-out"
              data-aos-duration="1400" > BỘ SƯU TẬP </Link>
          </div>
          <div className={cx('responsive')}>
            <Link href='/nemonline' data-aos="fade-right"
              data-aos-easing="ease-in-out"
          ...
          <div className={cx('responsive')}>
            ...
            <Link href='/sanphamnhapkhau' data-aos="fade-right"
              data-aos-easing="ease-in-out"
          ...
          <div onMouseOver={Getdata} className={cx('abc')}>
            <div className={cx('giohang')}>
              <Link data-aos="fade-right"
                data-aos-easing="ease-in-out"
                data-aos-duration="2600" href='/giohang'>
              ...
              <div className={cx('hovergiohang')}>
                ...
                <div className={cx('xemgiohang')} >
                  <h4 ><Link href='/giohang'> Xem giỏ hàng </Link></h4>
                </div>
              </div>
